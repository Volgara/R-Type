...
/*      auto *eg = engine::core::Engine::GetInstance();
      eg->addSystem("graphics", graphicSystem);
      eg->setScene(new core::Scene());
      gc = dynamic_cast<GraphicsComponent *>(eg->getScene()->CreateComponent(engine::core::GRA_SPRITE));*/
  ...
  engine::graphics::SpriteSheet       shipSheet      =
                                          engine::graphics::SpriteSheet("assets/mummy.png", 185, 225, 5, 5);
